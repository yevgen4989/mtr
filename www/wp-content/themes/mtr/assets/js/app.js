...
const 
    ...
    inputComponent = {
                        ...
                        emits: ['update:value'],
                        template: `<input :class="{app__input: true, app__input_error: hasError}" :placeholder="!hasError ? placeholder : errorMessage" :name="name" :value="value" autocomplete="off" @input="$emit('update:value', $event)">`,
                    },
    
    textInputComponent = {
                        props: ['placeholder', 'value', 'name'],
                        emits: ['update:value'],
                        template: `<textarea :class="{app__textarea: true}" :placeholder="placeholder" :name="name" autocomplete="off" @input="$emit('update:value', $event)">{{value}}</textarea>`,
                    },
                                                ...
                                                template: `
                                                    <div class="app__panel app__panel_white">
                                                        ...
                                                        <div v-if="!loadData & !calculateFinish && !calculateFinish" class="app__form" >
                                                            <selector @change="changeCountry" :hasError="this.isCountryError" :items="countries" @focus="this.isCountryError = false;" name="country"></selector>
                                                            <field :hasError="isCargoError" :errorMessage="this.language.requiredField" :placeholder="this.language.cargoName" v-on:input="cargo = $event.target.value" @focus="this.isCargoError = false;" v-bind:value="cargo" name="cargo"></field>
                                                            <field :hasError="isWeightError" :errorMessage="ErrorWeightMessage" :placeholder="this.language.weightName" :value="weight" @focus="this.isWeightError = false;" @update:value="validateWeight($event)" name="weight"></field>
                                                            <field :hasError="isContactError" :errorMessage="this.language.requiredField" :placeholder="this.language.contactName" :value="contact" @focus="this.isContactError = false;" @update:value="contact = $event.target.value" name="contact"></field>
                                                            <btn :title="this.language.next" :isGreen="true" :isNoMB="true" @click="calculate"></btn>
                                                        </div>
                                                        <div v-if="calculateFinish" class="app__form">
                                                            <span class="app__message" v-if="!calculateError">{{this.language.calculationPrice}} {{this.calcualtePrice}}$</span>
    ...
    ScreenComponentSearchCargoAndManufacture = {
                                                    ...
                                                    <div class="app__panel app__panel_white">
                                                        ...
                                                        <div class="app__form" v-if="!loadData && !sendedRequest">
                                                            <field :hasError="isCargoError" :errorMessage="this.language.requiredField" :placeholder="this.language.cargoName" v-on:input="cargo = $event.target.value" @focus="this.isCargoError = false;" v-bind:value="cargo" name="cargo"></field>
                                                            <field :placeholder="this.language.weightName" v-on:input="weight = $event.target.value" v-bind:value="weight" name="weight"></field>
                                                            <field :placeholder="this.language.manufactureName" v-on:input="manufacture = $event.target.value" v-bind:value="manufacture" name="manufacture"></field>
                                                            <field :hasError="isCityError" :errorMessage="this.language.requiredField" :placeholder="this.language.cityName" v-on:input="city = $event.target.value" @focus="this.isCityError = false;" v-bind:value="city" name="city"></field>
                                                            <field :hasError="isNameError" :errorMessage="this.language.requiredField" :placeholder="this.language.nameName" v-on:input="name = $event.target.value" @focus="this.isNameError = false;" v-bind:value="name" name="name"></field>
                                                            <field :hasError="isContactError" :errorMessage="this.language.requiredField" :placeholder="this.language.contactName" v-on:input="contact = $event.target.value" @focus="this.isContactError = false;" v-bind:value="contact" name="contact"></field>
                                                            <textField :placeholder="this.language.commentName" v-on:input="comment = $event.target.value" v-bind:value="comment" name="comment"></textField>
