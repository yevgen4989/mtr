// /******/ import {window} from "../../../../../wp-includes/js/codemirror/csslint";
...
/* harmony import */ var _Sender__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Sender */ "./resources/js/Sender.js");
/* harmony import */ var _HintWindow__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./HintWindow */ "./resources/js/HintWindow.js");
/* harmony import */ var _FormElementController__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./FormElementController */ "./resources/js/FormElementController.js");
...
function () {
  function Calculator() {
    ...
    this.hintWindow = new _HintWindow__WEBPACK_IMPORTED_MODULE_4__["default"](this.SELECTOR_HINT_WINDOW);
  ...
  _createClass(Calculator, [
    ...
    value: function addVariableParams() {
      ...
      for (var _i = 0; _i < this.variable_params.items.length; _i++) {
        ...
        var $tmpPanel = $tmpRange.find(_FormElementController__WEBPACK_IMPORTED_MODULE_5__["default"].SELECTOR_PANEL_DATA());
        _FormElementController__WEBPACK_IMPORTED_MODULE_5__["default"].addActionPanel($tmpPanel);
      }
    }
  },
    {
    ...
    value: function send() {
      if (this.validate()) {
        ...
        $.post(wp.url, this.getData(), function (data) {
          var self = obj;
          if (data.success == false) {
            self.$wnd.setTitle('Ошибка формления заявки');
...
function () {
  function blogPaginatorController() {
    ...
    this.TMP_ITEM = '<a href="" class="announcement__item" data-item="">' + '<div class="announcement__item__title">' + '<h3 class="title title__size3"></h3>' + '</div>' + '<div class="announcement__item__labels">' + '<span class="label">Статьи</span>' + '</div>' + '</a>';
    ...
    $(document).bind('scroll', function (ev) {
      ...
      if (Math.round(pos) > 50 && self.canUpdate) {
        ...
        // var sender = new _Sender__WEBPACK_IMPORTED_MODULE_0__["default"]({
        //   'page': self.currentPage,
        //   'type': self.activeType,
        //   'search': self.$searchInput.val()
        // }, function (data) {
        //   data.json().then(self.handleAnswer.bind(self));
        // }, self.PATH);
        // sender.send();
    ...
    value: function handleAnswer(data) {
      ...
      if (data.length > 0) {
        for (var i = 0; i < data.length; i++) {
          this.$element.append(this.generateHtmlItem(data[i]));
        }
...
__webpack_require__(/*! /Users/roman/develop/mtrgroup.local/www/resources/js/script.js */"./resources/js/script.js");
module.exports = __webpack_require__(/*! /Users/roman/develop/mtrgroup.local/www/resources/sass/frontend.scss */"./resources/sass/frontend.scss");
