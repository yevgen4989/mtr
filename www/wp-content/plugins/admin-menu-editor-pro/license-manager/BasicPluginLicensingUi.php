...
class Wslm_BasicPluginLicensingUI {
	...
	public function __construct(Wslm_LicenseManagerClient $licenseManager, $pluginFile, $updateChecker = null, $keyConstant = null) {
		...
		//add_filter( 'plugin_action_links_' . $basename, array($this, 'addLicenseActionLink') );
		//add_filter('network_admin_plugin_action_links_' . $basename,array($this, 'addLicenseActionLink'));
