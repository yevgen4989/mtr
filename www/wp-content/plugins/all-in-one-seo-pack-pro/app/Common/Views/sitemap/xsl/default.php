...
>
		...
		<body>
			<div id="content">
				<div id="content-head">
					<h1>XML Sitemap</h1>
					<p>
						<?php echo __( 'This is an XML Sitemap, meant to be consumed by search engines like Google or Bing.', 'all-in-one-seo-pack' ); ?><br/>
						<?php
	...
	<xsl:template name="sitemapTable">
		...
		<table cellpadding="3">
			...
			<tr>
				<th width="50%">URL</th>
                <?php /** @var TYPE_NAME $advanced */
                /** @var TYPE_NAME $excludeImages */
