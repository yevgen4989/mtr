...
class Frontend {
	...
	public function output( $echo = true, $attributes = [] ) {
		...
		$sitemap = sprintf(
			'<div class="content-grid content-grid_nmargin-mobile"><div class="content-grid__item content-grid__item_full content-grid__item_show"><div class="aioseo-html-sitemap%s">',
