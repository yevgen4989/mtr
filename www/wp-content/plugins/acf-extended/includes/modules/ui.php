...
class acfe_enhanced_ui{
    ...
    function admin_enqueue_scripts(){
         ...
         * Settings
         */
        elseif(acf_is_screen(array('options-general', 'options-writing', 'options-reading', 'options-discussion', 'options-media', 'options-permalink', 'settings_page_site_option'))){
