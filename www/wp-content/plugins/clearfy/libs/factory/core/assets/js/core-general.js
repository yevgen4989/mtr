...
(function($) {
	...
	$.wfactory_447.filters = $.wfactory_447.filters || {
	...
	$.wfactory_447.hooks = $.wfactory_447.hooks || {

		/**
		 * Applies filters to a given input value.
		 */
		run: function(filterName, args) {
			$.wfactory_447.filters.run(filterName, args);
		},
		 ...
		 */
		add: function(filterName, callback, priority) {
			$.wfactory_447.filters.add(filterName, callback, priority);
		}
	};
