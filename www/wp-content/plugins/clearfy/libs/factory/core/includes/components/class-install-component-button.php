...
namespace WBCR\Factory_447\Components;
...
class Install_Button {
	 ...
	 * @since  4.3.3
	 */
	public function __construct(\Wbcr_Factory447_Plugin $plugin, $type, $plugin_slug)
	{
		...
		$this->add_data('i18n', \WbcrFactoryClearfy239_Helpers::getEscapeJson($this->get_i18n()));
	...
	{
		return [
			'activate' => __('Activate', 'wbcr_factory_447'),
			'install' => __('Install', 'wbcr_factory_447'),
			'deactivate' => __('Deactivate', 'wbcr_factory_447'),
			'delete' => __('Delete', 'wbcr_factory_447'),
			'loading' => __('Please wait...', 'wbcr_factory_447'),
			'preparation' => __('Preparation...', 'wbcr_factory_447'),
			'read' => __('Read more', 'wbcr_factory_447')
		];
	}
