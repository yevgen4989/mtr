<?php
	...
	if( !class_exists('Wbcr_FactoryForms444_Bootstrap3FormLayout') ) {
		/**
		 * A form layout based on Twitter Bootstrap 3
		 */
		class Wbcr_FactoryForms444_Bootstrap3FormLayout extends Wbcr_FactoryForms444_FormLayout {
			...
			/**
			 * @param Wbcr_FactoryForms444_Control $control
			 */
