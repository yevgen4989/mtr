<?php
	...
	if( !class_exists('Wbcr_FactoryForms444_FormElement') ) {
		 ...
		 * @since 1.0.0
		 */
		abstract class Wbcr_FactoryForms444_FormElement {
			 ...
			 *
			 * @since 1.0.0
			 * @var Wbcr_FactoryForms444_HtmlAttributeBuilder
			 */
			 ...
			 * @param Wbcr_FactoryForms444_Form $form A parent form.
			 */
			public function __construct($options, $form)
			{
				...
				$this->html_builder = new Wbcr_FactoryForms444_HtmlAttributeBuilder();
