<?php
	...
	if( !class_exists('Wbcr_FactoryForms444_OptionsValueProvider') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryForms444_OptionsValueProvider implements Wbcr_IFactoryForms444_ValueProvider {
