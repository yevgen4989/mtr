<?php
	...
	if( !class_exists('Wbcr_FactoryForms444_Control') ) {
		 ...
		 * @since 1.0.0
		 */
		abstract class Wbcr_FactoryForms444_Control extends Wbcr_FactoryForms444_FormElement {
			 ...
			 *
			 * @param mixed[] $options
			 * @param FactoryForms444_Form $form
			 * @param null $provider
			 * @since 1.0.0
			 * @return void
			 */
			 ...
			 *
			 * @since 1.0.0
			 * @param IFactoryForms444_ValueProvider $provider
			 * @return void
			 */
