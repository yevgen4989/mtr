<?php
	...
	if( !class_exists('Wbcr_FactoryForms444_ControlHolder') ) {
		/**
		 * The base class for control holders.
		 *
		 * @since 1.0.0
		 */
		abstract class Wbcr_FactoryForms444_ControlHolder extends Wbcr_FactoryForms444_Control {
			 ...
			 *
			 * @since 1.0.0
			 * @return Wbcr_FactoryForms444_FormElement[].
			 */
