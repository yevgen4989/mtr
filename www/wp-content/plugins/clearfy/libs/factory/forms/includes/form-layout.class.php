<?php
	...
	if( !class_exists('Wbcr_FactoryForms444_FormLayout') ) {

		/**
		 * The base class for all form layouts.
		 */
		abstract class Wbcr_FactoryForms444_FormLayout extends Wbcr_FactoryForms444_Holder {
			...
			public function __construct($options, $form)
			{
				...
				$this->addCssClass('factory-forms-444-' . $this->type);
				$this->addCssClass('factory-forms-444-' . $this->name);
			}
