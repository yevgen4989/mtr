<?php
	...
	if( !class_exists('Wbcr_FactoryForms444_TabHolder') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryForms444_TabHolder extends Wbcr_FactoryForms444_Holder {
			 ...
			 * @param FactoryForms444_Form $form A parent form.
			 */
				...
				<div class="factory-headers">
					<ul class="nav nav-tabs">
						<?php foreach($this->elements as $element) {
							...
							$builder = new Wbcr_FactoryForms444_HtmlAttributeBuilder();
