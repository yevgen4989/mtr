<?php
	 ...
	 *  // see FactoryForms444_DropdownControl
	 * 'dropdown' => array(
	 ...
	 *    ),
	 * // see FactoryForms444_RadioColorsControl
	 * 'colors' => array(
	 *   // a callback to return items or an array of items to select
	 *   'data' => array(
	...
	if( !class_exists('Wbcr_FactoryForms444_DropdownAndColorsControl') ) {
		
		class Wbcr_FactoryForms444_DropdownAndColorsControl extends Wbcr_FactoryForms444_ComplexControl {
			...
			public function __construct($options, $form, $provider = null)
			{
				...
				$this->dropdown = new Wbcr_FactoryForms444_DropdownControl($options['dropdown'], $form, $provider);
				$this->colors = new Wbcr_FactoryForms444_RadioColorsControl($options['colors'], $form, $provider);
