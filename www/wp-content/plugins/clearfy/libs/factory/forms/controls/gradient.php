<?php
	...
	if( !class_exists('Wbcr_FactoryForms444_GradientControl') ) {
		class Wbcr_FactoryForms444_GradientControl extends Wbcr_FactoryForms444_Control {
			...
			public function html()
			{
				...
				<script>
					...
					factory.res.resVertical = '<?php _e( 'vertical', 'wbcr_factory_forms_444' ) ?>';
					factory.res.resHorizontal = '<?php _e( 'horizontal', 'wbcr_factory_forms_444' ) ?>';
				</script>
				<div <?php $this->attrs() ?>>
