<?php
	...
	if( !class_exists('Wbcr_FactoryForms444_ColorAndOpacityControl') ) {
	}

	class Wbcr_FactoryForms444_ColorAndOpacityControl extends Wbcr_FactoryForms444_ComplexControl {
		...
		public function __construct($options, $form, $provider = null)
		{
			...
			$this->opacity = new Wbcr_FactoryForms444_IntegerControl($options['opacity'], $form, $provider);
