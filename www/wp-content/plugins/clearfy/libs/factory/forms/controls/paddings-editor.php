<?php
	...
	if( !class_exists('Wbcr_FactoryForms444_PaddingsEditorControl') ) {

		class Wbcr_FactoryForms444_PaddingsEditorControl extends Wbcr_FactoryForms444_Control {
				...
				<div <?php $this->attrs() ?>
					...
					<div class="factory-slider-container">
						<label class="factory-title">
							<?php _e('Select a side and move the slider to set up:', 'wbcr_factory_forms_444') ?>
						</label>
