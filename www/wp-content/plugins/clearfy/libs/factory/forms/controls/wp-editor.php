<?php
	...
	if( !class_exists('Wbcr_FactoryForms444_WpEditorControl') ) {

		class Wbcr_FactoryForms444_WpEditorControl extends Wbcr_FactoryForms444_Control {
			...
			protected function beforeHtml()
			{
				...
				if( !isset($this->options['tinymce']['content_css']) ) {
					$this->options['tinymce']['content_css'] = FACTORY_FORMS_444_URL . '/assets/css/editor.css';
				}
			}
