function wbcr_factory_logger_112_LogCleanup(element) {
    ...
    jQuery.ajax({
        ...
        method: 'post',
        data: {
            action: 'wbcr_factory_logger_112_logs_cleanup',
            nonce: wbcr_factory_logger_112.clean_logs_nonce
        },
        success: function (data) {
            ...
            jQuery.wbcr_factory_clearfy_239.app.showNotice(data.message, data.type);
        },
        error: function (jqXHR, textStatus, errorThrown) {
            jQuery.wbcr_factory_clearfy_239.app.showNotice('Error: ' + errorThrown + ', status: ' + textStatus, 'danger');
            btn.html(currentBtnText);
        }
    });
}
