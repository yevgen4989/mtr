 ...
 *
 * Этот класс унаследован от стандартного шаблона страницы \Wbcr_FactoryPages446_ImpressiveThemplate,
 ...
 *
 * @package WBCR\FactoryClearfy239\Pages
 * @author        Alex Kovalev <alex.kovalevv@gmail.com>, Github: https://github.com/alexkovalevv
 * @since         2.2.2
 */
class Setup extends \Wbcr_FactoryPages446_ImpressiveThemplate {
	...
	public function __construct(\Wbcr_Factory447_Plugin $plugin)
	{
		...
		$this->menu_title = __('Setup master', 'wbcr_factory_clearfy_239');
		$this->page_menu_short_description = __('Setup master', 'wbcr_factory_clearfy_239');
		parent::__construct($plugin);
	}

	public function getPageTitle()
	{
		return __('Setup', 'wbcr_factory_clearfy_239');
	}
	...
	public function assets($scripts, $styles)
	{
		...
		$this->styles->add(FACTORY_CLEARFY_239_URL . '/assets/css/page-setup.css');
	...
	{
		?>
		<div class="w-factory-clearfy-239-setup">
			<ol class="w-factory-clearfy-239-setup-steps">
			...
			<div class="w-factory-clearfy-239-setup-content">
				<?php echo $content; ?>
			</div>
			<a class="w-factory-clearfy-239-setup-footer-links" href="<?php echo esc_url($this->get_close_wizard_url()); ?>">
				<?php _e('Not now', 'wbcr_factory_clearfy_239') ?>
			</a>
		</div>
		<?php
	}
