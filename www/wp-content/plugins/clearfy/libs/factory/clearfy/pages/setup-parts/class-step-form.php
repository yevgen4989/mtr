...
class Step_Form extends Step {
	...
	public function __construct(\WBCR\FactoryClearfy239\Pages\Setup $page)
	{
	...
	protected function render_form(\Wbcr_FactoryForms444_Form $form)
	{
		?>
		<form method="post" id="w-factory-clearfy-239__setup-form-<?php echo $this->get_id() ?>" class="w-factory-clearfy-239__setup-form form-horizontal">
			<?php $form->html(); ?>
			<div class="w-factory-clearfy-239__form-buttons">
				<!--<input type="submit" name="skip_button_<?php /*echo $this->get_id() */ ?>" class="button-primary button button-large w-factory-clearfy-239__skip-button" value="<?php /*_e('Skip', 'wbcr_factory_clearfy_239') */ ?>">-->
				<input type="submit" name="continue_button_<?php echo $this->get_id() ?>" class="button-primary button button-large w-factory-clearfy-239__continue-button" value="<?php _e('Continue', 'wbcr_factory_clearfy_239') ?>">
			</div>
		</form>
		<?php
	}

	protected function set_form_handler(\Wbcr_FactoryForms444_Form $form)
	{
	...
	public function html()
	{
		...
		<div id="WBCR" class="wrap">
			<div class="wbcr-factory-pages-446-impressive-page-template factory-bootstrap-447 factory-fontawesome-000">
				<div class="w-factory-clearfy-239-setup__inner-wrap">
