...
namespace WBCR\Factory_Freemius_135\Premium;

use WBCR\Factory_Freemius_135\Entities\License;
use WBCR\Factory_Freemius_135\Entities\Plugin;
use WBCR\Factory_Freemius_135\Entities\Site;
use WBCR\Factory_Freemius_135\Entities\User;
use WBCR\Factory_447\Premium\Provider as License_Provider;
use Wbcr_Factory447_Plugin;
use WBCR\Factory_Freemius_135\Api;
use WP_Error;
use Exception;
...
final class Provider extends License_Provider {
	...
	/**
	 * @var \WBCR\Factory_Freemius_135\Api
	 */
	private $site_api;
	 ...
	 * @throws Exception
	 */
	public function __construct(Wbcr_Factory447_Plugin $plugin, array $settings)
	{
	...
	/**
	 * @return \WBCR\Factory_Freemius_135\Entities\License|null
	 * @throws Exception
	 */
	 ...
	 * @param bool $flush
	 *
	 * @return \WBCR\Factory_Freemius_135\Api
	 * @throws Exception
	 */
