...
if ( ! class_exists( 'Wbcr_FactoryPages446_Page' ) ) {

	class Wbcr_FactoryPages446_Page {
		...
		public function executeByName( $action ) {
			...
			if ( ! method_exists( $this, $actionFunction ) ) {
				...
				/*$custom_actions = apply_filters('wbcr/factory_pages_446/custom_actions', array(), $raw_action_name);
