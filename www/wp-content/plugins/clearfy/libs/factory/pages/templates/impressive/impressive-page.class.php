...
if( !class_exists('Wbcr_FactoryPages446_ImpressiveThemplate') ) {
	/**
	 * Class Wbcr_FactoryPages446_ImpressiveThemplate
	 */
	abstract class Wbcr_FactoryPages446_ImpressiveThemplate extends Wbcr_FactoryPages446_AdminPage {
		...
		{
			$this->menuIcon = FACTORY_PAGES_446_URL . '/templates/impressive/assets/img/webcraftic-plugin-icon.png';
		...
		public function assets($scripts, $styles)
		{
			...
			$this->styles->add(FACTORY_PAGES_446_URL . '/templates/impressive/assets/css/impressive.page.template.css');
		}
		...
		protected function showOptions()
		{
			...
			<div id="WBCR" class="wrap">
				<div class="wbcr-factory-pages-446-impressive-page-template factory-bootstrap-447 factory-fontawesome-000">
