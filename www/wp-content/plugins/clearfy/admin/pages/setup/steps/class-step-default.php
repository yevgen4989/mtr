 ...
 * @version 1.0
 */
class Step_Default extends \WBCR\FactoryClearfy239\Pages\Step_Custom {
	...
	public function html()
	{
		...
		<div class="w-factory-clearfy-239-setup__inner-wrap">
			<div class="w-factory-clearfy-239-setup-step__new_onboarding-wrapper">
				<p class="w-factory-clearfy-239-setup-step__new_onboarding-welcome">Welcome to</p>
				<h1 class="w-factory-clearfy-239-logo">
