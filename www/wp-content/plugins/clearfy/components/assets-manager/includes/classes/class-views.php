...
class WGZ_Views {
	 ...
	 * @param Wbcr_FactoryClearfy239_PageBase $page
	 *
	 * @return bool|string       The page contents. False if the template doesn't exist.
	 */
	public function get_template( $template, $data = [], Wbcr_FactoryClearfy239_PageBase $page = null ) {
	 ...
	 * @param Wbcr_FactoryClearfy239_PageBase $page
	 */
	public function print_template( $template, $data = [], Wbcr_FactoryClearfy239_PageBase $page = null ) {
