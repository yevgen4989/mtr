 ...
 * @since 1.0.0
 */
class WMAC_MinifyAndCombineSettingsPage extends Wbcr_FactoryClearfy239_PageBase {
...
This can be fully automated for different types of pages with the Мinify And Combine CriticalCSS Power-Up.', 'minify-and-combine'),
		 ...
		 */
		return wbcr_factory_447_apply_filters_deprecated('wbcr_mac_settings_form_options', [$formOptions], '1.1.1', 'wmac/pages/settings_form_options');
	}
