...
class Form_Entity {
	...
	{
		return isset($item['type']) && isset(\Wbcr_FactoryForms444_Manager::$registered_controls[$item['type']]);
	}
	...
	{
		return isset($item['type']) && isset(\Wbcr_FactoryForms444_Manager::$registered_holders[$item['type']]);
	}
	...
	{
		return isset($item['type']) && isset(\Wbcr_FactoryForms444_Manager::$registered_custom_elements[$item['type']]);
	}
